    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mood1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intentprofile = new Intent(Predictions.this, MoodActivity.class);
                intentprofile.putExtra("sign", sign);
        ...
        tabLayout.addTab(tabLayout.newTab().setText(Html.fromHtml("<font color=\"#000000\">Prediction</font>")));
        tabLayout.addTab(tabLayout.newTab().setText(Html.fromHtml("<font color='#3d3d3d'>Work</font color>")));
        tabLayout.addTab(tabLayout.newTab().setText(Html.fromHtml("<font color='#3d3d" +
                "3d'>Health</font color>")));
        tabLayout.addTab(tabLayout.newTab().setText(Html.fromHtml("<font color='#3d3d3d'>Love</font color>")));
    ...
    private class Test extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... Params) {
            ...
            try {
                ...
                post = new HttpPost("http://astro360horoscope.com/backend/api/daily.php");
