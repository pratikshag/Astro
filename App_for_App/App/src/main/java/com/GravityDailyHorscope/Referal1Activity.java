 ...
 */
public class Referal1Activity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refer1);
        final GlobalClass globalVariable = (GlobalClass) getApplicationContext();

        show1 = (TextView) findViewById(R.id.show2);
        show1.setText("Refer Friend");
        ...
        details1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intenthome1 = new Intent(Referal1Activity.this, ContentActivity.class);
        ...
        tcapply1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                /// Create Intent for SignUpActivity  abd Start The Activity
                Intent intenthome3 = new Intent(Referal1Activity.this, ContentActivity.class);
